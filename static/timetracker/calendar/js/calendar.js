...
(function($) {
	...
	function showEventsList(event, that, slider, self) {
		...
		slider.slideUp('fast', function() {
			...
			$('#cal-slide-content').on("click",".removebutton", function(e){
		        e.preventDefault();
		        ...
		        $(this).html("you sure?").click(function(){
		          $.ajax({
		            ...
		            success: function() {
							...
							$('.bottom-right').notify({
			                    message: { text: 'Entry Removed', type:'error' }
			                  }).show();  
		            },
		            error: function(){
		            	$('.removeme').removeClass('.removeme');
							...
							$('.bottom-right').notify({
			                    message: { text: 'There Has been an error', type:'error' }
			                  }).show();  
		            }
		          });
		        });
